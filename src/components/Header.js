...
export const Header = () => {
  const [theme, setTheme] = useState(
    localStorage.getItem("theme") || "dark" // Retrieve theme as a string directly
  );

  useEffect(() => {
    localStorage.setItem("theme", theme); // Store theme as a string directly
